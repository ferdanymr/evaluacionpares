...
/**
 * Capability definitions for the evaluacionpares module
 *
...
$capabilities = array(
    ...
    'mod/evaluacionpares:view' => array(
        'captype' => 'read',
    ...
    // Ability to add a new evaluacionpares to the course.
    'mod/evaluacionpares:addinstance' => array(
    ...
    // Ability to change the current phase (stage) of the evaluacionpares, for example
    // allow submitting, start assessment period, close evaluacionpares etc.
    'mod/evaluacionpares:switchphase' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/evaluacionpares:editdimensions' => array(
    ...
    // in the evaluacionpares as the authors
    'mod/evaluacionpares:submit' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'student' => CAP_ALLOW,
    ...
    // example submissions.
    'mod/evaluacionpares:peerassess' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'student' => CAP_ALLOW,
    ...
    'mod/evaluacionpares:manageexamples' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/evaluacionpares:allocate' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    // Ability to publish submissions, i.e. make them available when evaluacionpares is closed
    'mod/evaluacionpares:publishsubmissions' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/evaluacionpares:viewauthornames' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'student' => CAP_ALLOW,
    ...
    'mod/evaluacionpares:viewreviewernames' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/evaluacionpares:viewallsubmissions' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    // Ability to view published submission when the evaluacionpares is closed. Group mode
    // restrictions do not apply here, published submissions are available in all
    // groups even in the separate groups mode.
    'mod/evaluacionpares:viewpublishedsubmissions' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'student' => CAP_ALLOW,
    ...
    'mod/evaluacionpares:viewauthorpublished' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'student' => CAP_ALLOW,
    ...
    'mod/evaluacionpares:viewallassessments' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/evaluacionpares:overridegrades' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/evaluacionpares:ignoredeadlines' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/evaluacionpares:deletesubmissions' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/evaluacionpares:exportsubmissions' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'manager' => CAP_ALLOW,
