...
$string['modulename']            = 'evaluacionpares';
$string['pluginname']            = 'evaluacionpares';
$string['modulenameplural']      = 'Evaluacion de pares';
$string['evaluacionparesname']   = 'Nombre del taller';
